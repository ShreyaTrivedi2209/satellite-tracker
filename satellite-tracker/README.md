...
`.gitignore`, or license if you want to push this exact local project as-is.
...
git init
git add .
git commit -m "Initial satellite tracker dashboard"
git branch -M main
git remote add origin https://github.com/<your-username>/<your-repo-name>.git
git push -u origin main
```

If you already initialized Git here, skip `git init`. If `origin` already
